...
IMAGE_NAME="pdf-toolbox-tools"
CONTAINER_NAME="pdf-toolbox-tools-shell"
...
echo ""
echo -e "${GREEN}===========================================${NC}"
echo -e "${GREEN} PDF Toolbox Development Tools${NC}"
echo -e "${GREEN}===========================================${NC}"
echo ""
echo "Available scripts:"
echo -e "  ${YELLOW}./scripts/generate-assets.sh${NC}    - Generate logos & favicons from source"
echo -e "  ${YELLOW}./scripts/generate-secrets.sh${NC}   - Generate admin password & API key"
echo ""
echo "Certificate Management:"
echo -e "  ${CYAN}./scripts/generate-cert.sh${NC}      - Create self-signed PDF signing certificate"
echo -e "  ${CYAN}./scripts/ca-cert-workflow.sh${NC}   - CA-signed certificate (CSR + import)"
echo -e "  ${CYAN}./scripts/convert-to-p12.sh${NC}     - Convert PEM cert to P12 format"
echo ""
